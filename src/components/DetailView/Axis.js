...
function Axis(selection, yPosition, xDomain, xRange, ticks) {
  ...
  axis = selection.selectAll('.SongTimelineAxis')
  ...
  axisLine = axis.selectAll('.SongTimelineAxis--line')
  ...
  axisLabels = axis.selectAll('.SongTimelineAxis--label')
  ...
  axisTicks = axis.selectAll('.SongTimelineAxis--line__axistick')

  let tickColorScale = d3.scaleLinear().domain(xRange).range(['#ffffff', '#666666']);
